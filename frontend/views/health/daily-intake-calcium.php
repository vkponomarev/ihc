    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of Calcium:') ?>
                        <?=$result['dailyIntakeCalcium']?> <?= Yii::t('app', 'milligram') ?><br>


                        <?php if ($result['dailyIntakeCalciumPregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of Calcium during pregnancy:') ?>
                            <?=$result['dailyIntakeCalciumPregnant']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeCalciumLactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of Calcium for lactation:') ?>
                            <?=$result['dailyIntakeCalciumLactation']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

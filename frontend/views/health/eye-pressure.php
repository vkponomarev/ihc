    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?php if (($result['eyePressureMens']) and ($getParams['gender']==2)) :?>
                            <?= Yii::t('app', 'Average eye pressure in men:') ?> <?=$result['eyePressureMens']?>
                        <?php endif;?>

                        <?php if (($result['eyePressureWomens']) and ($getParams['gender']==1)) :?>
                            <?= Yii::t('app', 'Average eye pressure in women:') ?> <?=$result['eyePressureWomens']?>
                        <?php endif;?>

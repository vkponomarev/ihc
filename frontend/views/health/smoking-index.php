...
<div class="result-div-on">
    ...
    <div class="result-div-text">
        <span class="result-pre-text">
            ...
            <?= Yii::t('app', 'Smoking index:') ?> <?=$result['smokingIndex']?><br><br>


            <?= Yii::t('app', 'If the smoking index is greater than 10, then this is a reliable risk factor for the development of chronic obstructive pulmonary disease.') ?>

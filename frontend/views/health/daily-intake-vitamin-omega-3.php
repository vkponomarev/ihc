    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of vitamin Omega 3:') ?>
                        <?=$result['dailyIntakeVitaminOmega3']?> <?= Yii::t('app', 'gram') ?><br>


                        <?php if ($result['dailyIntakeVitaminOmega3Pregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin Omega 3 during pregnancy:') ?>
                            <?=$result['dailyIntakeVitaminOmega3Pregnant']?> <?= Yii::t('app', 'gram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminOmega3Lactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin Omega 3 for lactation:') ?>
                            <?=$result['dailyIntakeVitaminOmega3Lactation']?> <?= Yii::t('app', 'gram') ?><br>
                        <?php endif;?>


                        <?php if ($result['dailyIntakeVitaminOmega3HardWork']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin Omega 3 during hard work:') ?>
                            <?=$result['dailyIntakeVitaminOmega3HardWork']?> <?= Yii::t('app', 'gram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminOmega3IntensiveTraining']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin Omega 3 during intense turnings:') ?>
                            <?=$result['dailyIntakeVitaminOmega3IntensiveTraining']?> <?= Yii::t('app', 'gram') ?><br>
                        <?php endif;?>

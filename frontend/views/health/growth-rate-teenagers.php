    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?php if (($result['growRate']) and ($getParams['gender']==2)) :?>
                            <?= Yii::t('app', 'Average height for boys:') ?><br>
                            <?= Yii::t('app', 'small:') ?>
                            <?=$result['growRate'][1][0]?> <?= Yii::t('app', 'centimeter') ?>,
                            <?=$result['growRate'][1][1]?> <?= Yii::t('app', 'kilogram') ?><br>

                            <?= Yii::t('app', 'middle:') ?>
                            <?=$result['growRate'][2][0]?> <?= Yii::t('app', 'centimeter') ?>,
                            <?=$result['growRate'][2][1]?> <?= Yii::t('app', 'kilogram') ?><br>

                            <?= Yii::t('app', 'tall:') ?>
                            <?=$result['growRate'][3][0]?> <?= Yii::t('app', 'centimeter') ?>,
                            <?=$result['growRate'][3][1]?> <?= Yii::t('app', 'kilogram') ?><br>

                        <?php endif;?>

                        <?php if (($result['growRate']) and ($getParams['gender']==1)) :?>
                            <?= Yii::t('app', 'Average height for girls:') ?><br>
                            <?= Yii::t('app', 'small:') ?>
                            <?=$result['growRate'][1][0]?> <?= Yii::t('app', 'centimeter') ?>,
                            <?=$result['growRate'][1][1]?> <?= Yii::t('app', 'kilogram') ?><br>

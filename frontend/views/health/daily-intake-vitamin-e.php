    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of vitamin E:') ?>
                        <?=$result['dailyIntakeVitaminE'][0]?> <?= Yii::t('app', 'milligram') ?>,
                        <?=$result['dailyIntakeVitaminE'][1]?> <?= Yii::t('app', 'ME') ?><br>

                        <?php if ($result['dailyIntakeVitaminEPregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin E during pregnancy:') ?>
                            <?=$result['dailyIntakeVitaminEPregnant'][0]?> <?= Yii::t('app', 'milligram') ?>,
                            <?=$result['dailyIntakeVitaminEPregnant'][1]?> <?= Yii::t('app', 'ME') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminELactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin E for lactation:') ?>
                            <?=$result['dailyIntakeVitaminELactation'][0]?> <?= Yii::t('app', 'milligram') ?>,
                            <?=$result['dailyIntakeVitaminELactation'][1]?> <?= Yii::t('app', 'ME') ?><br>
                        <?php endif;?>

    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of Potassium:') ?>
                        <?=$result['dailyIntakePotassium']?> <?= Yii::t('app', 'milligram') ?><br>


                        <?php if ($result['dailyIntakePotassiumPregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of Potassium during pregnancy:') ?>
                            <?=$result['dailyIntakePotassiumPregnant']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakePotassiumLactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of Potassium for lactation:') ?>
                            <?=$result['dailyIntakePotassiumLactation']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakePotassiumIntensiveTraining']) :?>
                            <?= Yii::t('app', 'Average daily intake of Potassium during intense turnings:') ?>
                            <?=$result['dailyIntakePotassiumIntensiveTraining']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

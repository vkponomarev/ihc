    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average sugar daily intake:') ?>
                        <?=$result['dailyIntakeSugar']?> <?= Yii::t('app', 'gram') ?><br>
                        <?= Yii::t('app', 'Maximum sugar daily intake:') ?>
                        <?=$result['dailyIntakeSugarMax']?> <?= Yii::t('app', 'gram') ?><br>

    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of Magnesium:') ?>
                        <?=$result['dailyIntakeMagnesium']?> <?= Yii::t('app', 'milligram') ?><br>


                        <?php if ($result['dailyIntakeMagnesiumPregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of Magnesium during pregnancy:') ?>
                            <?=$result['dailyIntakeMagnesiumPregnant']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeMagnesiumLactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of Magnesium for lactation:') ?>
                            <?=$result['dailyIntakeMagnesiumLactation']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

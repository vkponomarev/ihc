    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average iron daily intake:') ?>
                        <?=$result['dailyIntakeIron']?> <?= Yii::t('app', 'milligram') ?><br>


                        <?php if ($result['dailyIntakeIronPregnant']) :?>
                            <?= Yii::t('app', 'Pregnant average iron daily intake:') ?>
                            <?=$result['dailyIntakeIronPregnant']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeIronSmoke']) :?>
                            <?= Yii::t('app', 'Smoke and alcohol users average iron daily intake:') ?>
                            <?=$result['dailyIntakeIronSmoke']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

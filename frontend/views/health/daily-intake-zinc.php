    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of Zinc:') ?>
                        <?=$result['dailyIntakeVitaminZinc']?> <?= Yii::t('app', 'milligram') ?><br>


                        <?php if ($result['dailyIntakeVitaminZincPregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of Zinc during pregnancy:') ?>
                            <?=$result['dailyIntakeVitaminZincPregnant']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminZincLactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of Zinc for lactation:') ?>
                            <?=$result['dailyIntakeVitaminZincLactation']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of vitamin C:') ?>
                        <?=$result['dailyIntakeVitaminC']?> <?= Yii::t('app', 'milligram') ?><br>


                        <?php if ($result['dailyIntakeVitaminCColds']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin C for colds:') ?>
                            <?=$result['dailyIntakeVitaminCColds']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminCPregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin C during pregnancy:') ?>
                            <?=$result['dailyIntakeVitaminCPregnant']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminCLactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin C for lactation:') ?>
                            <?=$result['dailyIntakeVitaminCLactation']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminCSportsman']) :?>
                            <?= Yii::t('app', 'Average daily vitamin C intake for athletes:') ?>
                            <?=$result['dailyIntakeVitaminCSportsman']?> <?= Yii::t('app', 'milligram') ?><br>
                        <?php endif;?>

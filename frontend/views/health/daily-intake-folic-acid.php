    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of Folic Acid:') ?>
                        <?=$result['dailyIntakeFolicAcid']?> <?= Yii::t('app', 'micrograms') ?><br>


                        <?php if ($result['dailyIntakeFolicAcidPregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of Folic Acid during pregnancy:') ?>
                            <?=$result['dailyIntakeFolicAcidPregnant']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeFolicAcidLactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of Folic Acid for lactation:') ?>
                            <?=$result['dailyIntakeFolicAcidLactation']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of vitamin B12:') ?>
                        <?=$result['dailyIntakeVitaminB12']?> <?= Yii::t('app', 'micrograms') ?><br>


                        <?php if ($result['dailyIntakeVitaminB12Pregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin B12 during pregnancy:') ?>
                            <?=$result['dailyIntakeVitaminB12Pregnant']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminB12Lactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin B12 for lactation:') ?>
                            <?=$result['dailyIntakeVitaminB12Lactation']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminB12Menopause']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin B12 during menopause:') ?>
                            <?=$result['dailyIntakeVitaminB12Menopause']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminB12HardWork']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin B12 during hard work:') ?>
                            <?=$result['dailyIntakeVitaminB12HardWork']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminB12IntensiveTraining']) :?>
                            <?= Yii::t('app', 'Average daily intake of vitamin B12 during intense turnings:') ?>
                            <?=$result['dailyIntakeVitaminB12IntensiveTraining']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

    ...
    <div class="result-div-text">
                <span class="result-pre-text">
                    ...
                    <?php if ($result['result']) :?>
                        ...
                        <?= Yii::t('app', 'Average daily intake of Iodine:') ?>
                        <?=$result['dailyIntakeVitaminIodine']?> <?= Yii::t('app', 'micrograms') ?><br>


                        <?php if ($result['dailyIntakeVitaminIodinePregnant']) :?>
                            <?= Yii::t('app', 'Average daily intake of Iodine during pregnancy:') ?>
                            <?=$result['dailyIntakeVitaminIodinePregnant']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminIodineLactation']) :?>
                            <?= Yii::t('app', 'Average daily intake of Iodine for lactation:') ?>
                            <?=$result['dailyIntakeVitaminIodineLactation']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

                        <?php if ($result['dailyIntakeVitaminIodineIntensiveTraining']) :?>
                            <?= Yii::t('app', 'Average daily intake of Iodine during intense turnings:') ?>
                            <?=$result['dailyIntakeVitaminIodineIntensiveTraining']?> <?= Yii::t('app', 'micrograms') ?><br>
                        <?php endif;?>

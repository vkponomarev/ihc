...
$cycleDuration = count($sizesMassive)-1;
$startId = 5662;
...
$pages_id = '';
$languages_id = '';
$menu_name = 'Лосины ' . $sizesMassive[$x] . ' размер';
$index_name = 'Лосины ' . $sizesMassive[$x] . ' размер';
$title = 'Лосины ' . $sizesMassive[$x] . ' размер онлайн | Таблица размеров';
$plates_title = 'Лосины ' . $sizesMassive[$x] . ' размер';
$h1 = 'Лосины ' . $sizesMassive[$x] . ' размер';
$description = 'Лосины ' . $sizesMassive[$x] . ' размер для женщин - онлайн калькулятор позволяет с высокой точностью рассчитать размеры лосин ' . $sizesMassive[$x] . ' размера для взрослых и детей мальчиков и девочек в виде таблицы.';
$text1 = 'Бесплатный онлайн сервис расчета размеров лосин ' . $sizesMassive[$x] . ' размера.';
$active = '1';

while ($x<=$cycleDuration) {

    /*$pages_id = $startId;
    $languages_id = 1;
    $menu_name = $itemName . ' ' . $sizesMassive[$x] . ' размер';
    $index_name = $itemName . ' ' . $sizesMassive[$x] . ' размер';
    $title = $itemName . ' ' . $sizesMassive[$x] . ' размер онлайн | Таблица размеров';
    $plates_title = $itemName . ' ' . $sizesMassive[$x] . ' размер';
    $h1 = $itemName . ' ' . $sizesMassive[$x] . ' размер';
    $description = $itemName . ' ' . $sizesMassive[$x] . ' размер для мужчин и женщин - онлайн калькулятор позволяет с высокой точностью рассчитать размеры ' . $itemName2 . ' ' . $sizesMassive[$x] . ' размера для взрослых и детей мальчиков и девочек в виде таблицы.';
    $text1 = 'Бесплатный онлайн сервис расчета размеров ' . $itemName2 . ' ' . $sizesMassive[$x] . ' размера.';
    $active = '1';*/
...
/*
    $model = new \common\models\PagesText();

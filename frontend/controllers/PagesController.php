...
use common\models\components\MainPagesData;
  ...
  */
    ...
    public function actionOne($url)
    {
        ...
        if ($pages->id == 9) {
            ...
            $pageViewData['calculationDate'] = $calculationDate;
            $pageViewData['pregnancyCalendar'] = MainPagesData::pregnancyCalendar($pregnancyCalculationMethod,$calculationDate);
            $pageViewData['pregnancyCalculation'] = WomanCalculators::pregnancyCalculation(
                $pregnancyCalculationData['pregnancyCalculationMethod'],
                $calculationDate);
            $pageViewData['allCalendarsData'] = [
                'nameOfMonthsInYear' => MainPagesData::nameOfMonthsInYear($calculationDate),
                'nameOfDaysInWeek' => MainPagesData::nameOfDaysInWeek(),
            ];
        ...
        if ($pages->id == 11) {
            ...
            $pageViewData['ovulationCalendar'] = MainPagesData::ovulationCalendar(
        ...
        if ($pages->id == 13) {
            ...
            $pageViewData['pregnancyCalculation'] = WomanCalculators::pregnancyCalculation(
                ...
                $calculationDate);
            $pageViewData['allCalendarsData'] = [
                'nameOfMonthsInYear' => MainPagesData::nameOfMonthsInYear($pageViewData['pregnancyCalendar']['calculationDate']),
                'nameOfDaysInWeek' => MainPagesData::nameOfDaysInWeek(),
            ];
            return $this->render($renderPage, $pageViewData);
        }
        ...
        if (($pages->id == 14) or($pages->id == 15) or ($pages->id == 16)) {
            ...
            $pageViewData['calculationDate'] = $calculationDate;
            $pageViewData['ovulationCalculationData'] = $ovulationCalculationData;
            $pageViewData['conceptionCalendar'] = MainPagesData::conceptionCalendar(
                $ovulationCalculationData['ovulationCalculationMenstrualLength'],
                $ovulationCalculationData['ovulationCalculationCycleLength'],
                $ovulationCalculationData['calculationDate']);
            $pageViewData['allCalendarsData'] = [
        ...
        if (($pages->id == 17)) {
            ...
            $pageViewData['conceptionChineseCalendar'] = MainPagesData::conceptionChineseCalendar(
        ...
        if (($pages->id == 24)) {
            ...
            $pageViewData['conceptionJapanCalendar'] = MainPagesData::conceptionJapanCalendar(

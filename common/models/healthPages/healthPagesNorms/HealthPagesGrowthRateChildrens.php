...
class HealthPagesGrowthRateChildrens
{


    public function growthRateChildrensCalculation($childGender, $childAgeYears, $childAgeMonths)
    {
        $viewResult = 1;
        if (!$childGender) {
            $childGender = 1;
        ...
        $womanCalculatorsDataArrays = new HealthPagesGrowthRateArray();
